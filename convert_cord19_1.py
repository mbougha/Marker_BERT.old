import argparse
from Processors.cord19 import convert_eval_dataset
...
def main():
    ...
    convert_eval_dataset(args.output_folder, args.queries_path, args.run_path, args.collection_path, args.set_name, args.num_eval_docs, False)
