import argparse
from Processors.msmarco_documents import convert_eval_dataset
...
def main():
    ...
    convert_eval_dataset(args.output_folder, args.qrels_path, args.queries_path, args.run_path, args.collection_path, 'test', args.num_eval_docs)
